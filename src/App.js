...
function App() {
  ...
  return (
      <div>
          <ul>
              <li>
                  <NavLink to="/" exact activeClassName="App-link">Home</NavLink>
              </li>
              <li>
                  <NavLink to="/login" activeClassName="App-link">Login</NavLink>
              </li>
              <li>
                  <NavLink to="/blogposts" exact activeClassName="App-link">Blogposts</NavLink>
              </li>
              <li>
                  <NavLink to="/blogpost/:blogId" activeClassName="App-link">Blogposts Overzicht</NavLink>
              </li>
          </ul>
...
// [x ] STAPPENPLAN ROUTING IMPLEMENTEREN
